...
assetsRouter.post(
  ...
  body('FirstName', 'must be a string').notEmpty(),
  body('LastName', 'must be a string').notEmpty(),
  body('UserId', 'must be a number').isNumeric(),
  body('Hospital', 'must be a string').notEmpty(),
  body('Data', 'must be a string').notEmpty(),
  ...
  body('Version', 'must be a number').isNumeric(),
