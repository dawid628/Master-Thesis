...
exports.assetsRouter.post('/', (0, express_validator_1.body)().isObject().withMessage('body must contain an asset object'), (0, express_validator_1.body)('ID', 'must be a string').notEmpty(), (0, express_validator_1.body)('FirstName', 'must be a string').notEmpty(), (0, express_validator_1.body)('LastName', 'must be a string').notEmpty(), (0, express_validator_1.body)('UserId', 'must be a number').isNumeric(), (0, express_validator_1.body)('Hospital', 'must be a string').notEmpty(), (0, express_validator_1.body)('Data', 'must be a string').notEmpty(), (0, express_validator_1.body)('Description', 'must be a string').notEmpty(), (0, express_validator_1.body)('ParentId')
    .optional()
    .custom((value) => {
    ...
    return true;
}), (0, express_validator_1.body)('Version', 'must be a number').isNumeric(), async (req, res) => {
    var _a;
    ...
    try {
        ...
        const jobId = await (0, jobs_1.addSubmitTransactionJob)(submitQueue, mspId, 'CreateAsset', assetId, req.body.UserId, req.body.FirstName, req.body.LastName, req.body.Hospital, req.body.Data, (_a = req.body.ParentId) !== null && _a !== void 0 ? _a : '', req.body.Version, req.body.Description);
